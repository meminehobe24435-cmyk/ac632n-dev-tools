...
files="app.bin br30loader.bin br30loader.uart uboot.boot uboot.boot_debug uboot_no_ota.boot uboot_no_ota.boot_debug p11_code.bin ota.bin ota_debug.bin isd_config.ini flash_params.bin"
