...
static const struct conn_update_param_t trans_connection_param_table[] = {
    {
        WTYI_BLE_COMPATIBLE_INTERVAL_MIN,
        WTYI_BLE_COMPATIBLE_INTERVAL_MAX,
        WTYI_BLE_COMPATIBLE_LATENCY,
        WTYI_BLE_COMPATIBLE_TIMEOUT
    },
};
...
static int trans_event_packet_handler(int event, u8 *packet, u16 size, u8 *ext_param)
{
    ...
    case GATT_COMM_EVENT_CONNECTION_COMPLETE:
        ...
        wtyi_ble_print_actual_conn_params(little_endian_read_16(ext_param, 14 + 0),
                                          little_endian_read_16(ext_param, 14 + 2),
                                          little_endian_read_16(ext_param, 14 + 4));
    ...
    case GATT_COMM_EVENT_CONNECTION_UPDATE_COMPLETE:
        ...
        wtyi_ble_print_actual_conn_params(little_endian_read_16(ext_param, 6 + 0),
                                          little_endian_read_16(ext_param, 6 + 2),
                                          little_endian_read_16(ext_param, 6 + 4));
        break;
    ...
    case GATT_COMM_EVENT_MTU_EXCHANGE_COMPLETE:
        ...
        wtyi_ble_print_actual_mtu(little_endian_read_16(packet, 2));
        break;
...
void bt_ble_init(void)
{
    ...
    ble_comm_set_config_name(WTYI_BT_BLE_NAME, 0);
    printf("[WTYI_BLE] adv_name=%s\n", ble_comm_get_gap_name());
    trans_con_handle = 0;
    trans_server_init();
