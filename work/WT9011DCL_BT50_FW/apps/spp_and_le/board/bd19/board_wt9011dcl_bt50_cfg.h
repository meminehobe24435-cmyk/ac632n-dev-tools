#ifndef CONFIG_BOARD_WT9011DCL_BT50_H
#define CONFIG_BOARD_WT9011DCL_BT50_H

#include "wtyi_config.h"
#include "board_wt9011dcl_bt50_global_build_cfg.h"
...
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					WTYI_UART_LOG_ENABLE                   //PA0未确认前默认关闭串口打印
...
#define TCFG_OTG_USB_DEV_EN                 BIT(0)//USB0 = BIT(0)保留下载, USB1给板载IIC
//*********************************************************************************//
//                                 IIC配置                                        //
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               WTYI_IIC_SCL_PORT                       //软件IIC  CLK=USB1DP
#define TCFG_SW_I2C0_DAT_PORT               WTYI_IIC_SDA_PORT                       //软件IIC  DAT=USB1DM
#define TCFG_SW_I2C0_DELAY_CNT              WTYI_IIC_DELAY_CNT                      //IIC延时参数
...
//                                 iokey 配置                                      //
//*********************************************************************************//
#define TCFG_IOKEY_ENABLE					DISABLE_THIS_MOUDLE //板载按键未确认连接前关闭
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   DISABLE_THIS_MOUDLE //PA1 PWR_ADC独立采样, 不使用PB1 ADKEY
#define TCFG_ADKEY_PORT                     NO_CONFIG_PORT
/*AD通道选择，需要和AD按键的端口相对应:
    ...
    AD_CH_PB2
*/
#define TCFG_ADKEY_AD_CHANNEL               WTYI_ADC_PWR_CH
...
#define TCFG_IRKEY_PORT                     NO_CONFIG_PORT
