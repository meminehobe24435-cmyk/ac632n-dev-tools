...
#define TCFG_LOWPOWER_LOWPOWER_SEL			0                            //测试阶段关闭低功耗，先保证蓝牙广播可见
/*强VDDIO等级配置,可选：
...
/* WTYI AC6321A hardware-test pins: PA10/PB10 are not defined on bd19 AC6321A. */
#undef TCFG_SW_I2C0_CLK_PORT
#undef TCFG_SW_I2C0_DAT_PORT
#undef TCFG_HW_I2C0_PORTS
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTA_07
#define TCFG_SW_I2C0_DAT_PORT               IO_PORTA_08
