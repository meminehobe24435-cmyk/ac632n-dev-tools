...
## 问题 8：硬编码绝对路径 `D:\23178\JL` 的可移植性

**现象/风险**：几乎所有脚本都硬编码 `D:\23178\JL`。

**证据**：
- `build_ac632n_spp_and_le.bat:3`、`serial_log_receiver.py:25` `DEFAULT_LOG_DIR`、`uart_print_gui.py:17` `LOG_DIR`、`ble_scan_wtyi.py:6` `sys.path.insert(0, r"D:\23178\JL\python_pkgs")`、`set_bt_name_and_build.ps1:7`、`env_check/show_env_check.bat:3`。
